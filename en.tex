...
Mainly worked on automated 2D line network plan (Bus lines,
Tram lines, Train lines, ...) generation.

\keywords{%
	Python, Linux, Ubuntu, Shell script,
	Git, Gitlab, Gitlab CI, CI/CD, MyPy,
	Unit Test, Scrum
}
}
\end{mytable}
...
\keywords{%
	...
	Unit Test, Integration Test, Microservice, REST, Scrum
}
}
\end{mytable}
...
\keywords{%
	...
	Microsoft TFS, Microsoft Project
}
}
\end{mytable}
