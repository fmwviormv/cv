...
\begin{mytable}
\myitem{2023-01 -- 2023-07}{%
\textbf{Python Developer} at
Delicious Data GmbH, Munich, Bayern, Germany.

Improved a complex backend data query report engine by developing a
flexible and secure query parser.

\keywords{%
	Python, Django, ORM, Data Query, MyPy, Pytest,
	Unit Test, Linux, Shell script, REST,
	Docker, Docker Compose,
	Git, Gitlab, Gitlab CI, CI/CD,
	Scrum
}
}
\end{mytable}
